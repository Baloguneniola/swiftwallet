    ...
    <section style={{
      ...
      <div style={{ flex: 1, maxWidth: '500px' }}>
        <h1 style={{
          ...
          Send money<br />
          <span style={{ color: '#22c55e' }}>instantly.</span><br />
          Securely.
        </h1>
        <p style={{
          color: '#aaa',
          ...
          Ready to change the way you move money? Swift Wallet lets you send, receive, and settle bills in seconds — right at your fingertips.
        </p>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ marginBottom: '16px' }}>
            ...
            <div style={{ color: '#aaa', fontSize: '11px', marginTop: '4px' }}>someone@gmail.com</div>
          </div>
          <div style={{ marginBottom: '20px' }}>
            <div style={{ color: '#888', fontSize: '11px' }}>Balance</div>
            <div style={{ color: '#22c55e', fontSize: '28px', fontWeight: '800' }}>₦42,500.00</div>
          </div>
